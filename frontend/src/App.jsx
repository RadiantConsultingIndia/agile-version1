...
import AIInterviewPractice from './pages/mentee/AIInterviewPractice'
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/mentee/ai-interview-practice" element={<PrivateRoute role="mentee"><AIInterviewPractice /></PrivateRoute>} />
